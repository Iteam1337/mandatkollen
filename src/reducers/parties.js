...
const parties = [
  {id: 1, name: 'Kristdemokraterna', percentage: 5.34, seats: 19, affiliation: 'regering', colour: '#3163A6', abbreviation: 'KD'},
  ...
  {id: 10, name: 'Övriga', affiliation: 'opposition', colour: '#4D4D4D', percentage: 1.54, seats: 0, abbreviation: 'Ö'}
]
