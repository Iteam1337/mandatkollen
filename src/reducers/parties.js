...
const initialState = [
  ...
  {id: 5, name: 'Sverigedemokr.', percentage: 13.50, affiliation: 'center', colour: '#e7d960', abbreviation: 'SD'},
  {id: 6, name: 'Socialdemokr.', percentage: 31.40, affiliation: 'regering', colour: '#c13b38', abbreviation: 'S'},
